<template>
  <div class="w-full input-wrap" :class="classes">
    <div>
      <div class="flex items-center">
        ...
        >
          ...
          <span
            ...
            class="text-accent-200 italic font-semibold"
          >
            * {{ error }}
          </span>
        </label>
      ...
      <div class="relative" :class="{ 'mt-2': !dense && !errorBelow }">
        <textarea
          v-if="multiLine"
          v-bind="$attrs"
          rows="6"
        ...
        >
          ...
          >
            <span
              class="text-gray-400 border-gray-700 rounded uppercase tracking-1"
              :class="maxClasses"
            >
              Max
            </span>
      ...
      <span
        v-if="error && errorBelow"
        class="text-accent-200 italic font-semibold absolute mt-1"
        :class="{ 'text-xs': small }"
      >
        * {{ error }}
      </span>
  ...
  computed: {
    ...
    error(): string | null {
      if (this.errors.length > 0) {
        return this.errors[0] as string
      }
